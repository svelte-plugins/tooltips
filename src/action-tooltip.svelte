...
<div bind:this={ref} class="tooltip animation-{animation} {position} {theme}" class:arrowless={!arrow} style="min-width: {minWidth}px; max-width: {maxWidth}px; text-align: {align};">
	{#if !isComponent}
		{@html content}
	{/if}
</div>
